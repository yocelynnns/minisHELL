...
void						handle_word(const char *input, int *start, int i,
								t_token **token_list);
int							handle_redirect(const char *input, int *i,
								int *start, t_token **token_list);
int							handle_pipe(const char *input, int *i, int *start,
								t_token **token_list, int *last_pipe);
...
void						parse_arguments(t_token **tokens,
								t_ast_node *command_node);
int							parse_all_redirects(t_token **tokens,
								t_ast_node *command_node);
t_ast_node					*parse_command(t_token **tokens);
t_ast_node					*parse_redirect(t_token **tokens);
int							ast_redirect(t_token **tokens,
								t_ast_node *command_node);
int							validate_redirect_type(t_token **tokens,
								t_ast_node *redirect_node);
int							capture_redirect_file(t_token **tokens,
								t_ast_node *redirect_node);
